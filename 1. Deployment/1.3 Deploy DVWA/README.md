...
- [DVWA Official Repository — digininja/DVWA](https://github.com/digininja/DVWA)
- [DVWA Docker Image Packages (GitHub Container Registry)](https://github.com/digininja/DVWA/pkgs/container/dvwa)
- [Setting-Up Damn Vulnerable Web Application (DVWA) in Docker — polarpwn.gg](https://polarpwn.netlify.app/blog/setting-up-dvwa/)
- [How to Setup DVWA on Docker — Medium (Nancy Muriithi)](https://medium.com/@Muriithi_nancy/how-to-setup-dvwa-on-docker-a3819ec25f78)
