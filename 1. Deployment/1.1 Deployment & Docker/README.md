...
![Docker Client](img/docker-client.png)
...
![Docker Objects](img/docker-objects.png)
...
![Docker Shell Usage](img/docker-shell-usage.png)
...
![Docker Shell Usage](img/docker-shell-usage-2.png)
...
![Docker Layer example](img/docker-layer-example.png)
...
![Contoh penggunaan Docker Compose](img/docker-compose-example-1.png)

![Contoh penggunaan Docker Compose #2](img/docker-compose-example-2.png)
